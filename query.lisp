...
(defun vua-kg-api-request (&key (content-type "application/json")) ;; Define the content-type
  "Function to query the VUA knowledge graph API"
  (let* ((http-request (format nil "https://api.druid.datalegend.net/queries/muhaiuser/example-query/run")) ;; copy your http request
